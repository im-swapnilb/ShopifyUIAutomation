...
public class BundleTest {
	...
	public String get_quantity_value = "1";
	public String buy_quantity_value = "2";
	...
	public void testBulk() throws Exception {
		...
		Thread.sleep(5000);
		driver.findElement(By.xpath(Obj.getProperty("get_quantity"))).sendKeys(get_quantity_value);
		Thread.sleep(5000);
		...
		driver.findElement(By.xpath(Obj.getProperty("popup_search_add_button"))).click();
		Thread.sleep(5000);
		driver.findElement(By.xpath(Obj.getProperty("buy_quantity"))).sendKeys(buy_quantity_value);
		Thread.sleep(5000);
		...
		s4.selectByVisibleText("Specific customers");
		Thread.sleep(5000);
...
//		driver.findElement(By.xpath(Obj.getProperty("date_picker_end_today"))).click();
		...
		CartPageDetalis cartPageDetalis = DiscountApplicationTest.testApp(ruleName, driver, Integer.parseInt(get_quantity_value)+Integer.parseInt(buy_quantity_value),productArray);
