...
public class UpSellCross_sellTest {

	public String ruleName = "Upsell/Cross-sell";
	...
	public String buy_quantity_value = "6";
...
//		driver.findElement(By.xpath(Obj.getProperty("date_picker_end_today"))).click();
		...
		CartPageDetalis cartPageDetalis = DiscountApplicationTest.testApp(ruleName, driver, Integer.parseInt(get_quantity_value),
				productArray);
